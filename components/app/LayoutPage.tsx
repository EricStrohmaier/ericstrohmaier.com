...
export function LayoutPage({ children }: LayoutProps) {
  return (
    <div className="flex size-full min-h-screen items-center justify-center bg-[var(--background)] py-2 text-[var(--text)] sm:p-9">
      <div className="mx-3 my-6 flex size-full min-h-[90%] max-w-7xl overflow-hidden rounded-[40px] bg-[var(--primary)]">
        <div className="z-20 h-full w-fit border-r bg-[var(--primary)] lg:min-h-full lg:w-1/3">
