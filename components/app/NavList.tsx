      ...
      <div className="flex flex-col items-center space-y-5 justify-center">
        ...
        <div className="md:w-[90%]">
          ...
          <nav className="mt-4 space-y-1 sm:block  flex flex-col justify-center items-center">
            ...
            <ListNavItem href="/programming-ideas" title="Programming Ideas" Icon={ListIcon} number={12} iconBgColor="yellow-500" />
            <ListNavItem href="/bucket-list" title="Bucket List" Icon={ListIcon} number={3} iconBgColor="blue-600" />
          </nav>
        </div>
      </div>
    </div>
