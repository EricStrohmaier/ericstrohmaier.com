export type ProjectStatus = "live" | "archived" | "on-hold" | "in-progress" | "offline";
...
function normalizeStatus(status: string): ProjectStatus {
  ...
  if (status.includes("live")) {
    ...
    return "in-progress";
  } else if (status.includes("frozen") || status.includes("hold")) {
    return "on-hold";
  } else if (status.includes("offline") || status.includes("localhost") || status.includes("deprec")) {
    return "offline";
  } else if (status.includes("arch")) {
    return "archived";
  } else {
    // Default fallback
    return "archived";
...
export const graveyardProjects: GraveyardProject[] = [
  {
    name: "recipe-api",
    description: "Scraped one recipe blog with 1000+ veggie recipes made a beautiful website to query it",
    date: "January 2, 2024",
    status: "offline",
  ...
  },
  {
    ...
    description: "Taking Linkedin urls and writing personalised job applications coverletters",
  ...
  {
    name: "Nostr Websites",
    description: "Playing with nostr technology, created a documentation website",
    date: "2023",
    status: "live",
  ...
  },
  {
    ...
    description: "Scraping Bitcoin jobs and posting them on Telegram, Nostr + website coming soon",
  ...
  },
  {
    ...
    description: "Student monthly rentals easy",
    date: "February 1, 2024",
    status: "in-progress",
    originalStatus: "progress/live",
  ...
  },
  {
    ...
    description: "Freelance: Versicherungs website - calculating offers + online checkout",
  ...
  },
  {
    ...
    description: "Freelance fullstack: Developing a backoffice app for internal use",
  ...
  },
  {
    ...
    description: "Agency with security focus or finish your AI vibe coding apps",
    date: "April 27, 2025",
    status: "live",
    originalStatus: "live",
